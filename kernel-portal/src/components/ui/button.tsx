...
const buttonVariants = cva(
  ...
  {
    variants: {
      /* Action hierarchy (decision 0034) — four tiers, descending emphasis:
         1 `action`  — decisive blue: the commit moment, at most one per view
         2 `default` — primary green: the main routine action of a region
         3 `outline` — secondary: white surface, any number of supporting actions
         4 `ghost`   — tertiary: quietest — cancel, dismiss, inline utilities
         `secondary` (brand-tinted) sits outside the ladder: toned chips and
         toggled states, not action clusters. */
      variant: {
