# 0054 — Shadows are tinted, and `--shadow-color` becomes real

Date: 2026-07-31
Status: accepted
Also recorded on the v2 prototype branch as 0061; this is the record for the change as it lands on main.
Extends: 0053 (elevation ramp per-theme alpha)
...
Deferred from decision 0053, which fixed the ramp's alphas and geometry and
...
0053 established. No literal colours remain in the ramp — changing
...
- **Tinting costs a little depth against pure black.** Measured on the dark
  ...
  precisely because dark's cast was already established (0053, and the page
...
- **Raise the alphas to compensate for the 0.3-level loss.** Rejected — 0053's
