  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // pill
        "group-data-[variant=pill]/tabs-list:rounded-full group-data-[variant=pill]/tabs-list:not-data-active:hover:text-foreground group-data-[variant=pill]/tabs-list:data-active:bg-primary group-data-[variant=pill]/tabs-list:data-active:text-primary-foreground group-data-[variant=pill]/tabs-list:data-active:shadow-sm",
        // underline
