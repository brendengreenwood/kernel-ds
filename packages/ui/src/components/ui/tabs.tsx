  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // Hover is an affordance for tabs you can move to — the active tab is
        // already there, so every variant's hover styling is inactive-only.
        // pill
        "group-data-[variant=pill]/tabs-list:rounded-full group-data-[variant=pill]/tabs-list:not-data-active:hover:text-foreground group-data-[variant=pill]/tabs-list:data-active:bg-traversal group-data-[variant=pill]/tabs-list:data-active:text-white dark:group-data-[variant=pill]/tabs-list:data-active:text-nav-950 group-data-[variant=pill]/tabs-list:data-active:shadow-sm",
        // underline
        "group-data-[variant=underline]/tabs-list:-mb-px group-data-[variant=underline]/tabs-list:rounded-none group-data-[variant=underline]/tabs-list:border-b-2 group-data-[variant=underline]/tabs-list:border-transparent group-data-[variant=underline]/tabs-list:not-data-active:hover:text-foreground group-data-[variant=underline]/tabs-list:data-active:border-traversal group-data-[variant=underline]/tabs-list:data-active:text-foreground",
