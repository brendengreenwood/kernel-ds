...
/** Return whether an unknown value satisfies the workspace preset contract. */
export function validateWorkspacePreset(value: unknown): boolean {
  return workspacePresetSchema.safeParse(value).success
}
