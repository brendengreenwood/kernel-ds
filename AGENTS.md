...
- DS lifecycle scripts: agents:check, agents:generate, changeset:status, ds:add, ds:changeset, ds:check, ds:doctor, ds:generate, ds:pack, ds:relate, ds:tag, ds:verify, release:check, release:impact, skills:check
