...
- DS lifecycle scripts: agents:check, agents:generate, changeset:status, consumers:check, ds:add, ds:changeset, ds:check, ds:doctor, ds:figma, ds:generate, ds:pack, ds:prototype, ds:relate, ds:release, ds:tag, ds:upgrade, ds:verify, release:check, release:impact, skills:check
- Skills: figjam-create-content, figma-analyze-component-set, figma-annotations, figma-arrange-component-set, figma-audit-accessibility, figma-blame-node, figma-check-design-parity, figma-comments, figma-component-properties, figma-deep-component, figma-design-system-inventory, figma-export-tokens, figma-extract-design-system, figma-generate-changelog, figma-generate-component-doc, figma-import-tokens, figma-library-variables, figma-lint-design, figma-manage-variables, figma-scan-code-accessibility, figma-setup-design-tokens, figma-slides, figma-version-history, kernel-ds-audit, kernel-ds-component, kernel-ds-definition, kernel-ds-document, kernel-ds-pattern, kernel-ds-release, kernel-ds-upgrade, kernel-ds-use, kernel-ds-verify, kernel-feature, kernel-norman, kernel-prototype, kernel-ship, kernel-studio, kernel-token, kernel-typesetting, kernel-verify, kernel-visual, migrate-radix-to-base, shadcn
